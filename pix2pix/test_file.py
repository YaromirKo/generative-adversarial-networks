...
class Pix2Pix:
    def __init__(self):
        ...
        self.dataset_name = 'The_Starry_Night'
    ...
    def build_generator(self):
        ...
        output_img = tf.keras.layers.Conv2D(self.channels, kernel_size=4, strides=1, padding='same', activation='tanh')(
            u7)
    ...
    def sample_images(self, epoch, batch_i):
        ...
        for i in range(r):
            for j in range(c):
                ...
                axs[i, j].axis('off')
                cnt += 1
        fig.savefig("./train_first/%s/%d_%d.png" % (self.dataset_name, epoch, batch_i))
        plt.close()
